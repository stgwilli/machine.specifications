...
namespace Machine.Specifications
{
    ...
    public static class ShouldExtensionMethods
    {
        ...
        static string ToUsefulString(this object obj)
        {
            string str;
...
{0}
        ...
        public static T ShouldBeAn<T>(this object item)
        {
            item.ShouldBeOfType<T>();
            return (T) item;
        }
...
does contain: {2}", items.EachToUsefulString(),
        ...
        public static void ShouldBeCloseTo(this float actual, float expected, float tolerance)
        {
            ...
            {
                throw new SpecificationException(string.Format("Should be within {0} of {1} but is {2}", tolerance.ToUsefulString(), expected.ToUsefulString(),
