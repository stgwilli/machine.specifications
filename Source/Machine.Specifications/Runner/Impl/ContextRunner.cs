...
namespace Machine.Specifications.Runner.Impl
{
    ...
    public class SetupOnceContextRunner : IContextRunner
    {
        ...
        static IEnumerable<Result> RunSpecifications(Context context, ISpecificationRunListener listener, RunOptions options,
                                                     IEnumerable<ISupplementSpecificationResults> resultSupplementers)
        {
        ...
        static IEnumerable<Result> FailSpecifications(Context context, ISpecificationRunListener listener, RunOptions options, Result result,
                                                      IEnumerable<ISupplementSpecificationResults> resultSupplementers)
        {
